...
type AutoCloseSettingsScreenRouteProp = RouteProp<
  RootStackParamList,
  'AutoCloseSettings'
>;
type AutoCloseSettingsScreenNavigationProp =
  StackNavigationProp<RootStackParamList>;

export const AutoCloseSettingsScreen: React.FC = () => {
  const navigation = useNavigation<AutoCloseSettingsScreenNavigationProp>();
  const route = useRoute<AutoCloseSettingsScreenRouteProp>();

  const { symbol, isLong } = route.params;
  ...
  const handleSet = () => {
    ...
    navigation.navigate('LongShort', {
      symbol,
      isLong,
      autoCloseEnabled: enabledState,
      autoCloseSettings: {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.keypadSection}>
        <Keypad
          ...
          size="medium"
          buttonBackgroundColor={colors.background.primary}
        />
      </View>
    </SafeAreaView>
  );
