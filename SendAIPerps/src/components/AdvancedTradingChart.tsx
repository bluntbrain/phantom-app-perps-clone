...
export const AdvancedTradingChart: React.FC<AdvancedTradingChartProps> = ({
  ...
  const generateCandleData = (basePrice: number): CandleData[] => {
    ...
    for (let i = 59; i >= 0; i--) {
      ...
      const volatility = openPrice * 0.002; // 0.2% volatility
  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderRelease: () => {
      ...
      // keep the hovered candle data visible after release
    },
  });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.chartHeader}>
        ...
        >
          <Icon name="maximize" size={18} color={colors.text.secondary} />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.instructions}>
        <Text style={styles.instructionText}>
          Tap & hold: Crosshair • Two fingers: Pan • Tap fullscreen for advanced
          features
        </Text>
      </View>
